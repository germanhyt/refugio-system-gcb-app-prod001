...
@php
    ...
    $reserveUrl = $restaurant->reservationWhatsappUrl();
    $icons = [
    ...
    <div class="rg-rest-social-bar">
        @if($links !== [])
            <div class="rg-rest-social" aria-label="Redes sociales">
                ...
                <div class="rg-rest-social-row">
                    @foreach($links as $link)
                        @continue(! isset($icons[$link['key']]))
                        <a
                            href="{{ $link['url'] }}"
                            target="_blank"
                            rel="noopener noreferrer"
                            class="rg-rest-social-icon"
                            aria-label="{{ $link['label'] }} de {{ $restaurant->name }}"
                        >
