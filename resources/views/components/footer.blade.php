                ...
                <div class="rg-footer-col">
                    ...
                    <ul class="rg-footer-nav">
                        @foreach($primary as $item)
                            <li><a href="{{ route($item['route']) }}" data-rg-track="click_nav" data-rg-label="{{ $item['label'] }}">{{ $item['label'] }}</a></li>
                        @endforeach
                    </ul>
                </div>
                ...
                <div class="rg-footer-col">
                    ...
                    <div class="rg-footer-social">
                        @if($settings->instagram_url)
                            <a href="{{ $settings->instagram_url }}" target="_blank" rel="noopener" class="rg-footer-social-icon" aria-label="Instagram" data-rg-track="click_social" data-rg-label="Instagram">
                        ...
                        @if($settings->youtube_url)
                            <a href="{{ $settings->youtube_url }}" target="_blank" rel="noopener" class="rg-footer-social-icon" aria-label="YouTube" data-rg-track="click_social" data-rg-label="YouTube">
                                <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                            </a>
                        @endif
                        @if($facebook)
                            <a href="{{ $facebook }}" target="_blank" rel="noopener" class="rg-footer-social-icon" aria-label="Facebook" data-rg-track="click_social" data-rg-label="Facebook">
                        ...
                        @endif
                        @if($tiktok)
                            <a href="{{ $tiktok }}" target="_blank" rel="noopener" class="rg-footer-social-icon" aria-label="TikTok" data-rg-track="click_social" data-rg-label="TikTok">
