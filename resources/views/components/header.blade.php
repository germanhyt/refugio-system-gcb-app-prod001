    ...
    <div class="rg-header-inner bg-gradient-to-b from-black/55 via-black/25 to-transparent">
            ...
            <div class="rg-header-hero-row">
                ...
                <div class="rg-header-col rg-header-col--actions">
                    <a
                        ...
                        target="_blank"
                        rel="noopener"
                        class="btn-reserva-ghost rg-header-reserva"
                        data-rg-track="click_reserva"
                        data-rg-label="Reserva aquí"
                    >
                        ¡Reserva aquí!
                    </a>
        ...
        <div class="rg-header-sticky">
            ...
            <div class="rg-sticky-right">
                ...
                <a href="{{ route('restaurants.index') }}" class="btn-provoc btn-provoc--sticky" data-rg-track="click_provoca" data-rg-label="Qué te provoca">¿Qué te provoca?</a>
            ...
            <div class="rg-menu-content">
                <div class="rg-menu-toolbar">
                    <div class="rg-menu-toolbar-ctas">
                        <a
                            ...
                            data-rg-track="click_reserva"
                            data-rg-label="Reserva aquí menú"
                            @click="menuOpen = false"
                        >¡Reserva aquí!</a>
                        <a
                            href="{{ route('restaurants.index') }}"
                            class="btn-provoc-menu"
                            data-rg-track="click_provoca"
                            data-rg-label="Qué te provoca menú"
                            @click="menuOpen = false"
                        >¿Qué te provoca?</a>
                    </div>
                ...
                <div class="rg-menu-footer">
                    <div class="rg-menu-socials">
                        <a href="{{ $instagram }}" target="_blank" rel="noopener" class="rg-menu-social" aria-label="Instagram" data-rg-track="click_social" data-rg-label="Instagram">
                        ...
                        @if($youtube)
                            <a href="{{ $youtube }}" target="_blank" rel="noopener" class="rg-menu-social" aria-label="YouTube" data-rg-track="click_social" data-rg-label="YouTube">
                                <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                            </a>
                        @endif
                        <a href="{{ $facebook }}" target="_blank" rel="noopener" class="rg-menu-social" aria-label="Facebook" data-rg-track="click_social" data-rg-label="Facebook">
                        ...
                        @if($tiktok)
                            <a href="{{ $tiktok }}" target="_blank" rel="noopener" class="rg-menu-social" aria-label="TikTok" data-rg-track="click_social" data-rg-label="TikTok">
